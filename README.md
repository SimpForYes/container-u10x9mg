...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-u10x9mg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-u10x9mg.containers.anotherwebservice.com/
...
```
git clone git@github.com:SimpForYes/container-u10x9mg.git
cd container-u10x9mg
```
...
```
docker attach container-u10x9mg
```
